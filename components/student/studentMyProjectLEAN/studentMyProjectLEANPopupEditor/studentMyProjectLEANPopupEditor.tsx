...
import styles from "./studentMyProjectLEANPopupEditorStyle.scss";

interface StudentMyProjectLEANPopupEditorProps {
 ...
 */
class StudentMyProjectLEANPopupEditor extends React.PureComponent<StudentMyProjectLEANPopupEditorProps> {
    ...
    constructor(props: StudentMyProjectLEANPopupEditorProps) {
        super(props);
...
export default StudentMyProjectLEANPopupEditor;
