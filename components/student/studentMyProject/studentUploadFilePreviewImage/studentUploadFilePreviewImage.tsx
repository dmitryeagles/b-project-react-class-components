...
import styles from './studentUploadFilePreviewImageStyle.scss';

interface StudentUploadFilePreviewImageProps {
...
function StudentUploadFilePreviewImage(props: StudentUploadFilePreviewImageProps) {
    return (
        <>
            {
...
export default React.memo(StudentUploadFilePreviewImage);
