...
import {
    ReportFinalTestingResultsByUser,
...
import styles from './reportFinalTestingResultsStyle.scss';
...
//region ReportFinalTestingResults
interface ReportFinalTestingResultsProps {
    readonly report: ReportFinalTestingResultsByUser;
...
function ReportFinalTestingResults(props: ReportFinalTestingResultsProps) {
...
export default React.memo(ReportFinalTestingResults);
