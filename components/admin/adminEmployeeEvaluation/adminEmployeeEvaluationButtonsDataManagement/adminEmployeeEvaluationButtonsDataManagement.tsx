...
import styles from "./adminEmployeeEvaluationButtonsDataManagementStyle.scss";
...
function AdminEmployeeEvaluationButtonsDataManagement(props: ShiftManagerEmployeeEvaluationButtonsDataManagementProps) {
    return (
...
export default React.memo(AdminEmployeeEvaluationButtonsDataManagement);
