...
import styles from "./adminProjectResourceAlignmentItemsListStyle.scss";

interface AdminProjectResourceAlignmentItemProps extends AdminActionButtonsProps {
...
function AdminProjectResourceAlignmentItem(props: AdminProjectResourceAlignmentItemProps) {
...
function AdminProjectResourceAlignmentItemsList(props: SmartComponentProps<StorePageContentProjectAdminResourceAlignment>) {
    ...
    for (let i = 0; i < dataOnCurrentPage.length; ++i) {
        feedbackSEVItemsElements.push(
            <AdminProjectResourceAlignmentItem
...
export default observer(AdminProjectResourceAlignmentItemsList);
