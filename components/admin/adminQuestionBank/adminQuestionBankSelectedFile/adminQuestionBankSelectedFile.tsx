...
import styles from "./adminQuestionBankSelectedFileStyle.scss";

function AdminQuestionBankSelectedFile(props: SmartComponentProps<StoreSelectedFile>) {
...
export default observer(AdminQuestionBankSelectedFile);
