...
import {StoreAdminPageContentUserKpi} from "../../../stores/admin/userKpi/storeAdminPageContentUserKpi";
...
import styles from './adminAttestationUserKpiStyle.scss';

interface UserKpiItemProps {
...
const UserKpiItem = React.memo((props: UserKpiItemProps) => {
    return (
        <StandardPanel
...
function AdminAttestationUserKpiList(props: SmartComponentProps<StoreAdminPageContentUserKpi>) {
