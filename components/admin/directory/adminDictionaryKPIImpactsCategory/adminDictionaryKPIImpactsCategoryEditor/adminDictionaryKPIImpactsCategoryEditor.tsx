...
import styles from './adminDictionaryKPIImpactsCategoryEditorStyle.scss';
...
function AdminDictionaryKPIImpactsCategoryEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryKPIImpactsCategory>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название категории KPI воздействия:'}>
...
export default observer(AdminDictionaryKPIImpactsCategoryEditor);
