...
import styles from './adminDictionaryNMTagClassificationEditorStyle.scss';
...
function AdminDictionaryNMTagClassificationEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryNMTagClassification>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название классификации бирки Tech NearMiss:'}>
...
export default observer(AdminDictionaryNMTagClassificationEditor);
