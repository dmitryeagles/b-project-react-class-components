...
import styles from './adminDictionarySEVKindEditorStyle.scss';
...
function AdminDictionarySEVKindEditor(props: SmartComponentProps<StoreAdminPageContentDictionarySEVKind>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название вида SEV:'}>
...
export default observer(AdminDictionarySEVKindEditor);
