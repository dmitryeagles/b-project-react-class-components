...
import styles from './adminDictionaryJobTitleEditorStyle.scss';
...
function AdminDictionaryJobTitleEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryJobTitle>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название должности:'}>
...
export default observer(AdminDictionaryJobTitleEditor);
