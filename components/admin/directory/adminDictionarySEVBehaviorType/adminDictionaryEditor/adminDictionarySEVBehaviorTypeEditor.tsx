...
import styles from './adminDictionarySEVBehaviorTypeEditorStyle.scss';
...
function AdminDictionarySEVBehaviorTypeEditor(props: SmartComponentProps<StoreAdminPageContentDictionarySEVBehaviorType>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название типа поведения:'}>
...
export default observer(AdminDictionarySEVBehaviorTypeEditor);
