...
import styles from './adminDictionaryKPICategoryEditorStyle.scss';
...
function AdminDictionaryKPICategoryEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryKPICategory>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название категории KPI:'}>
...
export default observer(AdminDictionaryKPICategoryEditor);
