...
import styles from './adminDictionarySevRiskDegreeCatalogEditorStyle.scss';
...
function AdminDictionarySevRiskDegreeCatalogEditor(props: SmartComponentProps<StoreAdminPageContentDictionarySevRiskDegreeCatalog>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название степени риска:'}>
...
export default observer(AdminDictionarySevRiskDegreeCatalogEditor);
