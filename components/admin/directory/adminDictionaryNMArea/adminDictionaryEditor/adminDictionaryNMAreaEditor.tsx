...
import styles from './adminDictionaryNMAreaEditorStyle.scss';
...
function AdminDictionaryNMAreaEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryNMArea>) {
...
export default observer(AdminDictionaryNMAreaEditor);
