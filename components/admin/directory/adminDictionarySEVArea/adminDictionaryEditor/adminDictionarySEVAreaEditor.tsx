...
import styles from './adminDictionarySEVAreaEditorStyle.scss';
...
function AdminDictionarySEVAreaEditor(props: SmartComponentProps<StoreAdminPageContentDictionarySEVArea>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название участка:'}>
...
export default observer(AdminDictionarySEVAreaEditor);
