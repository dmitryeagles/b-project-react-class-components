...
import {
    StoreAdminPageContentDictionaryArea
} from "../../../../../stores/admin/area/storeAdminPageContentDictionaryArea";
...
import styles from './adminDictionaryAreaEditorStyle.scss';
...
function AdminDictionaryAreaEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryArea>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название участка / оборудования:'}>
...
export default observer(AdminDictionaryAreaEditor);
