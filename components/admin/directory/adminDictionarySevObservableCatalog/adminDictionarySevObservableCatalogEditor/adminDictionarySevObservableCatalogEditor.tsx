...
import styles from './adminDictionarySevObservableCatalogEditorStyle.scss';
...
function AdminDictionarySevObservableCatalogEditor(props: SmartComponentProps<StoreAdminPageContentDictionarySevObservableCatalog>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Наименование наблюдаемого:'}>
...
export default observer(AdminDictionarySevObservableCatalogEditor);
