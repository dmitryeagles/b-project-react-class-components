...
import styles from './adminDictionaryNMEquipmentEditorStyle.scss';
...
function AdminDictionaryNMEquipmentEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryNMEquipment>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Оборудование:'}>
...
export default observer(AdminDictionaryNMEquipmentEditor);
