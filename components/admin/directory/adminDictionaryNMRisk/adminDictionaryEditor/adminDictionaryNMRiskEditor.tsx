...
import styles from './adminDictionaryNMRiskEditorStyle.scss';
...
function AdminDictionaryNMRiskEditor(props: SmartComponentProps<StoreAdminPageContentDictionaryNMRisk>) {
    ...
    return (
        ...
        >
            <AdminLabelWithContainerTwoLine label={'Название риска:'}>
...
export default observer(AdminDictionaryNMRiskEditor);
