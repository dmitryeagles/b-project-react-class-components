...
import styles from './adminDictionarySevObservationTypeEditorStyle.scss';
...
function AdminDictionarySevObservationTypeEditor(props: SmartComponentProps<StoreAdminPageContentDictionarySevObservationType>) {
...
export default observer(AdminDictionarySevObservationTypeEditor);
