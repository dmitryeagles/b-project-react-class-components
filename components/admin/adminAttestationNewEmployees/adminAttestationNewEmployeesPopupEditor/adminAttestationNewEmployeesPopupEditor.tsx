...
import styles from "./adminAttestationNewEmployeesPopupEditorStyle.scss";

interface AdminAttestationNewEmployeesPopupEditorProps {
 ...
 */
class AdminAttestationNewEmployeesPopupEditor extends React.PureComponent<AdminAttestationNewEmployeesPopupEditorProps> {
    ...
    constructor(props: AdminAttestationNewEmployeesPopupEditorProps) {
        super(props);
...
export default AdminAttestationNewEmployeesPopupEditor;
