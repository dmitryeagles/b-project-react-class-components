...
import {
    StoreShiftManagerPageReportProtocolAttestationCommission
} from "../../stores/shiftManager/reports/reportProtocolAttestationCommission/storeShiftManagerPageReportProtocolAttestationCommission";

class PageShiftManagerReportProtocolAttestationCommission extends React.PureComponent<PageComponentProps<StoreShiftManagerPageReportProtocolAttestationCommission>> {
    constructor(props: PageComponentProps<StoreShiftManagerPageReportProtocolAttestationCommission>) {
        super(props);
    }
        ...
        return (
            <PageContainer>
                <PageContainer>
                    ...
                    <ReportProtocolAttestationCommissionSmart
                        store={this.props.storePage.storeContentPage.storeReportProtocolAttestationCommission}/>
                </PageContainer>
            </PageContainer>
        );
    }
...
export default observer(PageShiftManagerReportProtocolAttestationCommission);
