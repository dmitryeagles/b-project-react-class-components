...
import {StoreAdminPageFeedbackNM} from "../../stores/admin/feedbackNM/storeAdminPageFeedbackNM";

class PageAdminFeedbackNM extends React.PureComponent<PageComponentProps<StoreAdminPageFeedbackNM>> {
    constructor(props: PageComponentProps<StoreAdminPageFeedbackNM>) {
        super(props);
    }
...
export default observer(PageAdminFeedbackNM);
