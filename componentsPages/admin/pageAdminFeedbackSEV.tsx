...
import {StoreAdminPageFeedbackSEV} from "../../stores/admin/feedbackSEV/storeAdminPageFeedbackSEV";

class PageAdminFeedbackSEV extends React.PureComponent<PageComponentProps<StoreAdminPageFeedbackSEV>> {
    constructor(props: PageComponentProps<StoreAdminPageFeedbackSEV>) {
        super(props);
    }
...
export default observer(PageAdminFeedbackSEV);
